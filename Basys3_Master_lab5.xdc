...
set_property PACKAGE_PIN R2 [get_ports {calibrate}]					
...
set_property PACKAGE_PIN T18 [get_ports btn_down_ss]						
	set_property IOSTANDARD LVCMOS33 [get_ports btn_down_ss]
set_property PACKAGE_PIN W19 [get_ports btn_left_ss]						
	set_property IOSTANDARD LVCMOS33 [get_ports btn_left_ss]
...
##Pmod Header JA
##Sch name = JA1
#set_property PACKAGE_PIN J1 [get_ports {to_filter}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {to_filter}]
##Sch name = JA2
#set_property PACKAGE_PIN L2 [get_ports {op_comp}]					
...
##Pmod Header JB
##Sch name = JB1
set_property PACKAGE_PIN A14 [get_ports {to_filter}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {to_filter}]
##Sch name = JB2
